...
import { isHumanModeEnabled, getHumanConfig, randomIntInRange, randomInRange, type HumanConfig } from './human.js';
...
export class Page extends BasePage {
   ...
   */
  protected override async _humanScrollWheel(deltaY: number): Promise<void> {
