...
export interface IBrowserFactory {
  connect(opts?: { timeout?: number; workspace?: string; cdpEndpoint?: string; initialUrl?: string }): Promise<IPage>;
  close(): Promise<void>;
}
...
export async function browserSession<T>(
  ...
  opts: { workspace?: string; cdpEndpoint?: string; initialUrl?: string } = {},
): Promise<T> {
