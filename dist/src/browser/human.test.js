...
import { isHumanModeEnabled, getHumanConfig, DEFAULT_HUMAN_CONFIG, randomInRange, randomIntInRange, easeInOut, generateBezierCurve, generateOvershootCurve, getAdjacentKey, ADJACENT_KEYS, generateScrollSteps, } from './human.js';
...
describe('Bezier curve generation', () => {
    ...
    it('adds jitter when specified', () => {
        ...
        const hasJitterDiff = pointsWithJitter.some((p, i) => Math.abs(p.x - pointsNoJitter[i].x) > 0.1 ||
